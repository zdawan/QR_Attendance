    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 p-4">
      <Card className="w-full max-w-md border-none shadow-xl">
        <CardHeader className="bg-gradient-to-r from-green-400 to-green-600 text-white">
          <CardTitle className="text-center text-2xl">Attendance Confirmed!</CardTitle>
        </CardHeader>
        <CardContent className="flex flex-col items-center p-6">
          ...
          <p className="mb-4 text-center">Your attendance has been successfully recorded.</p>
          ...
          <div className="mb-6 w-full rounded-lg bg-gray-50 p-4">
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className="text-sm font-medium">{studentInfo.departmentId}</div>
              ...
              {attendanceRecord && (
                <>
                  ...
                  <div className="text-sm font-medium">{attendanceRecord.sessionId}</div>
                  ...
                  {attendanceRecord.location && (
                    <>
                      ...
                      <div className="flex items-center text-sm font-medium">
                        ...
                        {attendanceRecord.isWithinRange ? "Within range" : "Outside range"}
                      </div>
                    </>
                  )}
                </>
